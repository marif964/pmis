...
<div class="content py-4">
 ...
 <button class="btn btn-sm btn-success btn-flat" id="edit_project"><i class="fa fa-edit"></i> Add Agreement</button>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <thead>
                        <tr class="bg-gradient-primary text-light">
                            ...
                            <th class="text-center">Agreement type</th>
                            <th class="text-center">Agreement status </th>
                            <th class="text-center">Contract Partner</th>
                            <th class="text-center">period</th>
                            <th class="text-center">Agreement Amount</th>
                            <th class="text-center">Contract Currency</th>
                            <th class="text-center">EUR Equivalent</th>
                            <th class="text-center">PKR Equivalent</th>
